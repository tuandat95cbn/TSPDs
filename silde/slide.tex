...
\end{figure}
\end{frame}
\section{Đề xuất thuật toán tìm kiếm cục bộ giải bài toán lập lộ trình giao hàng kết hợp xe tải và nhiểu thiết bị bay drone}
\begin{frame}{ Bài toán lập lộ trình giao hàng kết hợp xe tải và nhiểu thiết bị bay drone}
\begin{block}{Nhận xét}
Dựa vào các ưu nhược điểm của xe tải và drone được đưa ra vào phần trước. 
\begin{itemize}
\item Sử dụng thêm drone có thể giảm chi phí nhiểu hơn một drone.
\item Xe tải với năng lực của nó có thể mang nhiểu hơn 1 drone.
\end{itemize}
\end{block}
\end{frame}
